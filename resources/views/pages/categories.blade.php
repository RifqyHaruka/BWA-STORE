          ...
          <div class="container">
            ...
            <div class="row">
              ...
              @forelse ($categories as $category)
                  <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="{{ $AOSIncrement+=100 }}">
...
@forelse ($products as $product)
    <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="{{ $AOSIncrement+=100 }}">
